      ...
      <main class='bg-white p-10 max-w-sm rounded h-auto'>
        ...
        <form class="w-full max-w-sm" id='login-form'>
          ...
          <div class="md:flex md:items-center">
            <div class="md:w-1/3"></div>
            <div class="md:w-2/3">
              <button class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit" onClick={handleSubmit}>
                {/* Sign Up */}
                Play Tenzies
              </button>
            </div>
